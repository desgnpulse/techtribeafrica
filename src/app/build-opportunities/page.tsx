...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${cat.label} — TechTribe Africa`, description: cat.metaDescription, type: "website", images: [{ url: "/tta-og.jpg", width: 1200, height: 630, alt: "TechTribe Africa" }] },
