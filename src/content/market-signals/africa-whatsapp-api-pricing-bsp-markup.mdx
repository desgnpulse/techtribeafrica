...
The arbitrage is already in Meta's pricing table. Since November 2024, service messages - conversations that customers initiate - have been free. A business that generates inbound interest pays nothing for the reply window. A business sending outbound marketing messages pays $0.052 per message, plus BSP markup.
