export const CATEGORIES = {
  ...
  "build-opportunities": {
    ...
    color: "#7A4A10",
    description:
      "Specific market gaps worth building into. Backed by research, sized by reality. For founders and builders who want to know what's worth making before it's obvious.",
    metaDescription:
